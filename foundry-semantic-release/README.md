...
- **`CDN_DOMAIN`**: Custom domain for CDN (default: `downloads.futurehax.com`)
...
1. **If GCS_BUCKET_NAME + CDN_DOMAIN set**: Uses `https://downloads.futurehax.com/futurehax/{packageId}/v{version}/`
